(function( $ , api) {
    ...
    api.section( 'bakery_fof_options_section' , function( section ) {
    ...
    api.section( 'bakery_blog_options_section' , function( section ) {
    ...
    // Footer section
    api.section( 'bakery_footer_options_section' , function( section ) {

        section.expanded.bind( function( isExpanded ) {


            // Footer Widget option show/hide
            var $widget_toggle  = $('#bakery-widget-toggle-settings'),
                $widgettitle    = $('#customize-control-bakery_footer_widgettitlecolor_settings');
    ...
    api.section( 'colors' , function( section ) {
        ...
        section.expanded.bind( function( isExpanded ) {
            ...
            var $overlay_toggle  = $('#bakery-headeroverlay-toggle-settings'),
                $overlaytitle    = $('#customize-control-bakery_headeroverlaycolor');
