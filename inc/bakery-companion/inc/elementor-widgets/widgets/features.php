 ...
 * @since 1.0
 */
class Bakery_Features extends Widget_Base {

	public function get_name() {
		return 'bakery-features';
	}

	public function get_title() {
		return __( 'Features', 'bakery' );
	}
	...
	protected function _register_controls() {
        ...
        $this->start_controls_section(
            'features_heading',
            [
                'label' => __( 'Features Section Heading', 'bakery' ),
            ]
        );
        $this->add_control(
            'sect_title', [
		...
		$this->start_controls_section(
			'features_block',
			[
				'label' => __( 'Features', 'bakery' ),
			]
		);
		$this->add_control(
            'features_content', [
                'label' => __( 'Create Features', 'bakery' ),
        ...
        $this->start_controls_section(
            'style_features', [
                'label' => __( 'Style Features', 'bakery' ),
                'tab'   => Controls_Manager::TAB_STYLE,
            ]
        );
        $this->add_control(
            ...
            [
                'label'     => __( 'Style Feature Title ', 'bakery' ),
        ...
        $this->add_control(
            'color_feature_desc', [
                'label' => __( 'Feature Description Color', 'bakery' ),
                'type'  => Controls_Manager::COLOR,
                'default' => '#777',
                'selectors' => [
        ...
        $this->add_control(
            ...
            [
                'label'     => __( 'Style Font Icon', 'bakery' ),
                'type'      => \Elementor\Controls_Manager::HEADING,
                'separator' => 'before',
            ]
        );
        $this->add_control(
            'color_fonticon', [
                'label'     => __( 'Font Icon Color', 'bakery' ),
                'type'      => Controls_Manager::COLOR,
                'default'   => '#67bc00',
                'selectors' => [
        ...
        $this->add_control(
            'fontsize',
            [
                'label' => __( 'Icon Font Size', 'bakery' ),
