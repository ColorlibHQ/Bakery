<?php
/**
 * Class Name: bakery_bootstrap_navwalker
...
class bakery_bootstrap_navwalker extends Walker_Nav_Menu {
	...
	public static function fallback( $args ) {
		if ( current_user_can( 'manage_options' ) ) {
			...
			$fb_output .= '>';
			$fb_output .= '<li><a href="' . admin_url( 'nav-menus.php' ) . '">'.esc_html__( 'Add a menu', 'bakery' ).'</a></li>';
			$fb_output .= '</ul>';
...
class bakery_mobile_bootstrap_navwalker extends Walker_Nav_Menu {
...
// Social nav Walker
class bakery_social_navwalker extends Walker_Nav_Menu {
