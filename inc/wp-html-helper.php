...
// image default alt
if( ! function_exists( 'bakery_img_default_alt' ) ) {
	function bakery_img_default_alt( $url = '' ) {
...
// Image Tag
if( ! function_exists( 'bakery_img_tag' ) ) {
	function bakery_img_tag( array $args ) {
		...
		if( ! empty( $args['alt'] ) ) {
			...
			$alt = bakery_img_default_alt( $url );
		}
...
// Anchor Tag
if( ! function_exists( 'bakery_anchor_tag' ) ) {
	function bakery_anchor_tag( array $args ) {
		
		$default = array(
			'url' 	 		=> '',
			'text' 	 		=> esc_html__( 'Click Here', 'bakery' ),
			'target' 		=> '',
			'title' 		=> '',
			'class'  		=> '',
			'id' 	 		=> '',
...
// Heading Tag
if( ! function_exists( 'bakery_heading_tag' ) ) {
	function bakery_heading_tag( array $args ) {
		
		$default = array(
			'tag' 	 	  => 'h1',
			'text' 	 	  => esc_html__( 'Write Something', 'bakery' ),
			'class'  	  => '',
			'id' 	 	  => '',
			'wrap_before' => '',
			'wrap_after'  => '',
...
// Paragraph Tag
if( ! function_exists( 'bakery_paragraph_tag' ) ) {
	function bakery_paragraph_tag( array $args ) {
...
// Other Tag
if( ! function_exists( 'bakery_other_tag' ) ) {
	function bakery_other_tag( array $args ) {
...
// Button Element 
if( ! function_exists( 'bakery_button_element ' ) ) {
	function bakery_button_element( array $args ) {
		
		$default = array(
			'text' 	 	  => esc_html__( 'Button', 'bakery' ),
			'type'   	  => '',
			'class'  	  => '',
			'id' 	 	  => '',
			'wrap_before' => '',
