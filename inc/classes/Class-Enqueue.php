...
class Bakery_Enqueue {

	public $scripts = array();

	public function bakery_scripts_enqueue_init() {
		add_action( 'wp_enqueue_scripts', array( $this, 'bakery_frontend_enqueue_scripts', ) );
	}

	public function bakery_frontend_enqueue_scripts( ) {
