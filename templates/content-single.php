...
<div id="<?php the_ID(); ?>" <?php post_class( esc_attr( 'single-post row' ) ); ?>>
	...
	echo '<div class="col-lg-9 col-md-9 blog-detail-txt">';
        ...
        /**
         * Blog post title
         * @Hook  bakery_blog_posts_content
         *
	 ...
	 * @Hook  bakery_blog_posts_content
	 *
	 * @Hooked bakery_blog_posts_content_cb
	 * 
	 *
	 */
	do_action( 'bakery_blog_posts_content' );
...
/**
 * Blog single page content 
 * @Hook  bakery_blog_single_footer_nav
 *
 * @Hooked bakery_blog_single_footer_nav_cb
 * 
 *
 */
do_action( 'bakery_blog_single_footer_nav' );
